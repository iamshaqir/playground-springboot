...
public class UserController {
    ...
    @GetMapping("/orphan-check/{id}")
    public ResponseEntity<UserDetails> orphanRemoval(@PathVariable("id") Long id) {
        return ResponseEntity.ok(userService.orphanRemoval(id));
    }
